...
export interface ApiAnimeAnime extends Schema.CollectionType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::anime.anime', 'title'> & Attribute.Required;
    releaseDate: Attribute.Date & Attribute.Required;
    backdrop: Attribute.Media & Attribute.Required;
    ...
    seasons: Attribute.Integer & Attribute.Required;
    episodes: Attribute.Integer & Attribute.Required;
...
export interface ApiContentClassificationContentClassification
  ...
  info: {
    ...
    displayName: 'ContentClassification';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiDistributorDistributor extends Schema.CollectionType {
  ...
  attributes: {
    displayName: Attribute.String & Attribute.Required;
    slug: Attribute.UID<'api::distributor.distributor', 'displayName'> &
      Attribute.Required;
    anime: Attribute.Relation<
      'api::distributor.distributor',
      'oneToMany',
...
export interface ApiSiteSettingSiteSetting extends Schema.SingleType {
  ...
  attributes: {
    ...
    siteDescription: Attribute.String & Attribute.Required;
    logo: Attribute.Media;
    menuLink: Attribute.Component<'menu.menu-link', true>;
    footer: Attribute.RichText & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
